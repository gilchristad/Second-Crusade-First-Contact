...
public class Crusader extends Unit {
	...
	public Crusader(int atk, int acc, int spd, int dge, int sze, int viHP,int laHP,int raHP,int llHP,int rlHP,int chHP) {
	...
	public void somethingDied(int armourValue) {
		//Delete the armour that was destroyed, if that type of armour was already destroyed, delete the limb
